# loglevel [![Build Status](https://travis-ci.org/pimterry/loglevel.png)](https://travis-ci.org/pimterry/loglevel) ![Dependency status](https://david-dm.org/pimterry/loglevel.png)
